...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <style type="text/css">
            ...
            h1, h2, h3, h4, h5, h6{color:#5F5F5F; font-weight:normal; font-family:Helvetica, Arial; font-size:20px; line-height:125%; text-align:Left; letter-spacing:normal; margin-top:0; margin-right:0; margin-bottom:10px; margin-left:0; padding-top:0; padding-bottom:0; padding-left:0; padding-right:0;}
            ...
            #emailHeader{background-color:#FFFFF;}
            ...
            */
            ...
            .divHeader {padding:5px 10px; margin-top:25px; margin-bottom:10px;}
            .divLogo {width:40%;}
            
            .link {color:#337AB7; margin-top:5px; margin-bottom:5px; font-weight:bold !important;}
            ...
            @media only screen and (max-width: 480px){
                    ...
                    */
                    ...
                    /* aplido: own CSS*/
                    div[class="divLogo"] {width:65% !important;}
            ...
            <table border="0" cellpadding="0" cellspacing="0" height="100%" width="100%" id="bodyTable" style="table-layout: fixed;max-width:100% !important;width: 100% !important;min-width: 100% !important;">
                <tr>
                    <td align="center" valign="top" id="bodyCell">
                        ...
                        <!-- EMAIL HEADER // -->
                        <table bgcolor="#FFFFFF" border="0" cellpadding="0" cellspacing="0" width="500" id="emailHeader">[{*background-color of the header*}]
                            <!-- HEADER ROW // -->
                            <tr>
                                                            ...
                                                            <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                <tr>
                                                                        ...
                                                                        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width:100%;">
                                                                            <tr>
                                                                                <td align="left" class="textContent">
                                                                                    <div style="font-family:Helvetica,Arial,sans-serif; font-size:12px; color:#000000; text-align:center; line-height:120%;">
                                                                    ...
                                                                    <td align="right" valign="middle" class="flexibleContainerBox">
                                                                        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width:100%;">
                                                                            <tr>
                                                                                <td align="middle" class="textContent">
                                                                                    <!-- CONTENT // -->
                                                                                    <div style="font-family:Helvetica,Arial,sans-serif; font-size:12px; color:#000000; text-align:center; line-height:120%;">
                                                                                        <!-- If you can't see this message, <a href="#" target="_blank" style="text-decoration:none;border-bottom:1px solid #000000;color:#000000;"><span style="color:#000000;">view&nbsp;it&nbsp;in&nbsp;your&nbsp;browser</span></a>. -->
                                                                                    </div>
                                                                                    <div class="divHeader">
                                                                                        <div class="divLogo">
                                                                                            <img src="[{$oViewConf->getImageUrl('logo_email.png', false)}]" border="0" hspace="0" vspace="0" alt="[{$shop->oxshops__oxname->value}]" align="texttop" style="width:100%; max-width:300px;">
                                                                                        </div>
                                                                                    </div>
                                                                                </td>
                                                                            </tr>
                        ...
                        <table bgcolor="#FFFFFF"  border="0" cellpadding="0" cellspacing="0" width="500" id="emailBody">
                            ...
                            <tr>
                                <td align="left" valign="top">
                                    ...
                                    -->
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="color:#777777;" bgcolor="#FFFFFF">
                                        <tr>
                                            <td align="left" valign="top">
                                                <!-- FLEXIBLE CONTAINER // -->
                                                <!--
