...
[{block name="user_checkout_noregistration"}]
    <form action="[{$oViewConf->getSslSelfLink()}]" name="order" method="post">
        [{block name="user_checkout_noregistration_form"}]
            ...
            [{/block}]
            <h3 class="h3">[{oxmultilang ident="NOTREGISTERED_ACCOUNTINFO"}]</h3>
            ...
            <div class="m-t-1 m-b-1">
                <div class="m-b-1">
                    <label class="c-input c-checkbox">
                        <input id="showShipAddress" type="checkbox" name="blshowshipaddress" value="0" [{if !$oView->showShipAddress()}]checked[{/if}]>
