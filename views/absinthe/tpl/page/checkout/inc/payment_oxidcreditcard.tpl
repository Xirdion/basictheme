    ...
    <div class="row m-b-2">
        <div class="col-xs-12 col-sm-5 col-md-4">            
            ...
            <fieldset class="form-group">
                ...
                <input required class="form-control" type="text" maxlength="64" name="dynvalue[kknumber]" autocomplete="off" value="[{ $dynvalue.kknumber }]">
            </fieldset>
            ...
            <fieldset class="form-group">
                ...
                <input required class="form-control" type="text" maxlength="64" name="dynvalue[kkname]" autocomplete="off" value="[{ if $dynvalue.kkname }][{ $dynvalue.kkname }][{else}][{$oxcmp_user->oxuser__oxfname->value}] [{$oxcmp_user->oxuser__oxlname->value}][{/if}]">
            </fieldset>
            ...
            <fieldset class="form-group">
                ...
                <input required class="form-control" type="text" maxlength="64" name="dynvalue[kkpruef]" autocomplete="off" value="[{$dynvalue.kkpruef}]">
