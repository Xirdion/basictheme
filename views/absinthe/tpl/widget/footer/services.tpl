        ...
        <span class="h4">[{oxmultilang ident="SERVICES"}]</span>
            <ul class="m-t-1">
                [{block name="footer_services_items"}]
                    <li>
                        <a href="[{oxgetseourl ident=$oViewConf->getSelfLink()|cat:"cl=guestbook"}]" rel="nofollow">[{oxmultilang ident="GUESTBOOK"}]</a>
                    </li>
                    <li>
                        <a href="[{oxgetseourl ident=$oViewConf->getSelfLink()|cat:"cl=contact"}]" title="[{oxmultilang ident="CONTACT_TITLE"}]">[{oxmultilang ident="CONTACT"}]</a>
                    </li>
                    [{if $oViewConf->getHelpPageLink()}]
                        <li><a href="[{$oViewConf->getHelpPageLink()}]" title="[{oxmultilang ident="HELP_TITLE"}]">[{oxmultilang ident="HELP"}]</a></li>
                    [{/if}]
                    <li>
